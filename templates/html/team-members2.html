            ...
            <div class="col-md-9">
            	...
            	<ul class="nav wtf-menu">
                    ...
                    <li class="item-select parent"><a href="#.">Pages</a>
						...
						<li class="select-menu"> <a href="team-members2.html">Team Members Two</a> </li>
				...
				<ul>
                    ...
                    <li class="select"><a href="#.">Pages</a>
                    	<ul>
							...
							<li> <a href="patient-and-family.html">Patient and Family</a> </li>
							<li> <a href="team-members.html">Team Members One</a> </li>
							<li class="select"> <a href="team-members2.html">Team Members Two</a> </li>
							<li> <a href="research.html">Research</a> </li>
							<li> <a href="tables.html">Pricing tabels</a> </li>
                        </ul>
                    </li>
			...
			<div class="container">
				...
				<div class="col-md-12">
					<div class="main-title">
						<h2><span>Meet Our</span> Doctors</h2>
