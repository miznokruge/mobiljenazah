        ...
        <div class="row">
            ...
            <div class="col-md-9">
            	...
            	<ul class="nav wtf-menu">
					...
					<li class="item-select parent"><a href="#.">News</a>
					<ul class="submenu">
                        <li class="select-menu"> <a href="news-sidebar.html">Sidebar</a> </li>
    ...
    <div id="page">
			...
			<nav id="menu">
				<ul>
                    ...
                    <li class="select"><a href="#.">News Posts</a>
                    	<ul>
                        	<li class="select"> <a href="news-sidebar.html">Sidebar</a> </li>
							<li> <a href="news-text.html">Text-Based</a> </li>
							<li> <a href="news-single.html">Single Post</a> </li>
							<li> <a href="news-double.html">Double Post</a> </li>
							<li> <a href="news-masonary.html">Masonary</a> </li>
				...
				<div class="row">
					...
					<div class="col-md-4">
						...
						<div class="recent-posts">
							...
							<div class="post-sec">
								<a href="news-detail.html"><img src="images/blog/side-bar/recent-post1.jpg" alt=""></a>
								<a href="news-detail.html" class="title">Geometric Landscapes Heartologic</a>
								<span class="date">11 Minutes ago</span>
							</div>
							
							<div class="post-sec">
								<a href="news-detail.html"><img src="images/blog/side-bar/recent-post2.jpg" alt=""></a>
								<a href="news-detail.html" class="title">Geometric Landscapes Heartologic</a>
								<span class="date">2 Days ago</span>
							</div>
							<div class="post-sec">
								<a href="news-detail.html"><img src="images/blog/side-bar/recent-post3.jpg" alt=""></a>
								<a href="news-detail.html" class="title">Geometric Landscapes Heartologic</a>
