            	...
            	<ul class="nav wtf-menu">
                    ...
                    <li class="item-select parent"><a href="#.">Gallery</a>
						...
						<li class="parent"> <a href="#">Simple Gallery</a> <i class="icon-chevron-small-right"></i> 
                             <ul class="submenu">
                                    <li class="select-menu"> <a href="gallery-simple-two.html">Columns Two</a> </li>
					...
					<li class="select"><a href="#.">Gallery</a>
						...
						<ul>
                        	<li class="select"><a href="#.">Simple Gallery</a>
                            	<ul>
                                	<li class="select"> <a href="gallery-simple-two.html">Columns Two</a> </li>
                                    <li> <a href="gallery-simple-three.html">Columns Three</a> </li>
                                    <li> <a href="gallery-simple-four.html">Columns Four</a> </li>
                                </ul>
                            </li>
  ...
  <div class="gallery">
   		<div class="container">
            ...
            <div class="main-title">
                <h2><span>2 Columns</span> Gallery</h2>
